...
tf.flags.DEFINE_string('estimator_path'     , '/tmp/kkt'                            , 'The working path used by the estimator to process the data, hdfs://namenode is valid protocol')
tf.flags.DEFINE_string('export_model_path'  , '/tmp/export'                         , 'The path where the model is exported as .pb file, hdfs://namenode is valid protocol')
tf.flags.DEFINE_string('export_model_name'  , 'model.pb'                            , 'The name used to save the exported .pb file')
